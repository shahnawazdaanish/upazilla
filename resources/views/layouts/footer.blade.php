...
<script src="{{ asset("application/vendor/jquery-validation/dist/jquery.validate.min.js") }} "></script>
<script src="{{ asset("application/vendor/jquery-validation/dist/additional-methods.min.js") }} "></script>
<script src="{{ asset("application/vendor/jquery-nice-select-1.1.0/js/jquery.nice-select.min.js") }} "></script>
